...
## 🛠️ Technical Stack
- **Languages**: Python, HTML/CSS (Portfolio Integration)
...
- **Frontend & Visualization**: Streamlit, Interactive HTML Infographics
- **Deployment**: Docker, Google Cloud Run, GitHub Actions (Self-Hosted Runners)
